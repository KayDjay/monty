...
/**
 * struct opcode_func - opcode and its function
 * @file: the opcode file
 * @arg: arguement to handle the opcode
 * @buffer: pointer to line content
 */
...
extern opcode_ins opcode;

int main(int ac, char **av);
void read_file(char *filename, stack_t **head);
typedef void (*instruct_func)(stack_t **head, unsigned int line_number);
